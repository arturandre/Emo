...
output_path = r'C:\Users\Artur Oliveira\projetosdev\emo_pers_robot\Diana\quem4.wav'
...
# Duplicate the mono data across 4 channels
four_channel_data = np.tile(mono_data, (4, 1)).T

# Save the 4-channel data to a new .wav file
wavfile.write(output_path, sample_rate, four_channel_data)

print(f"Converted {input_path} to 4-channel and saved as {output_path}")
